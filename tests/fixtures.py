...
def pizza() -> RecipeDoc:
    return RecipeDoc(
        ...
        steps=[
            Step(n=1, text_md="Смешайте муку и воду, оставьте на 30 минут."),
            Step(
                n=2,
                text_md=(
                    "Вымешивайте тесто 10 минут. Готовое тесто перестаёт липнуть\n"
                    "к рукам и при растягивании просвечивает, не разрываясь."
                ),
            ),
            Step(n=3, text_md="Разделите на два шара и оставьте подходить на два часа."),
        ],
