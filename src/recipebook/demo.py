    ...
    return RecipeDoc(
        ...
        steps=[
            Step(
                n=1,
                text_md=(
                    "Смешайте муку и воду до однородности и оставьте на 30 минут. "
            ...
            Step(
                n=2,
                text_md=(
                    "Добавьте соль и дрожжи и вымешивайте 10 минут. Готовое тесто "
                    "перестаёт липнуть к рукам, а если растянуть кусочек между "
                    "пальцами, он просвечивает и не рвётся."
                ),
            ),
            Step(n=3, text_md="Разделите на два шара и оставьте подходить два часа."),
            Step(
                n=4,
                text_md=(
                    "Растяните руками от центра к краям, не трогая бортик. "
                    "Скалка выгоняет весь воздух, и край получается плоским."
                ),
            ),
            Step(n=5, text_md="Выпекайте на прогретом камне 6–8 минут при 250 °C."),
        ],
        notes_md=(
    ...
    return RecipeDoc(
        ...
        steps=[
            Step(
                n=1,
                text_md=(
                    "Нарежьте лук тонкими полукольцами и томите на сливочном масле "
                    "на среднем огне 40–50 минут. Мешайте каждые несколько минут. "
            ...
            Step(n=2, text_md="Влейте бульон и варите 30 минут на слабом огне."),
        ],
...
def _porridge() -> RecipeDoc:
    return RecipeDoc(
        ...
        steps=[
            Step(n=1, text_md="Смешайте всё в банке, закройте и уберите в холодильник."),
            Step(n=2, text_md="Утром перемешайте. Каша должна быть густой, но не сухой."),
        ],
        notes_md="",
    )
